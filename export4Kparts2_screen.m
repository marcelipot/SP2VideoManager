...
fileTemp = [tempfolder 'tempVid2.mp4'];
if ispc == 1;
...
vid2 = VideoWriter(fileTemp, profile);
vid2.Quality = 85; %cannot take higher
vid2.FrameRate = targetRate;
open(vid2);
...
%                 end;
        ...
        if mod(iterVid2,10) == 0;
            %Save image count every 10 iterations
            if ismac == 1;
                save('/Applications/SP2VideoManager/Temp/outputVid2.mat', 'iterVid2', 'iterVid2');
            elseif ispc == 1;
                save([MDIR '\SP2VideoManager\Temp\outputVid2.mat'], 'iterVid2', 'iterVid2');
            end;
        end;
        iterVid2 = iterVid2 + 1;
    end;
...
if ismac == 1;
    finishVid2 = 1;
    save('/Applications/SP2VideoManager/Temp/outputVid2.mat', 'finishVid2', 'iterVid2');
elseif ispc == 1;
    MDIR = getenv('USERPROFILE');
    finishVid2 = 1;
    save([MDIR '\SP2VideoManager\Temp\outputVid2.mat'], 'finishVid2', 'iterVid2');
end;
