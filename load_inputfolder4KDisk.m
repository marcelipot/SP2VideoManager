...
path = uigetdir('4K videos unput folder', handles.defaultpathinput4K);
pathfold = path;
if path == 0;
    return;
end;
handles.defaultpathinput4K = path;

disppath = path;
set(handles.pathinput4K_main, 'String', disppath, 'tooltip', path);
