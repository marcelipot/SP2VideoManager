...
fileTemp = [tempfolder 'tempVid4.mp4'];
if ispc == 1;
...
vid4 = VideoWriter(fileTemp, profile);
vid4.Quality = 85; %cannot take higher
vid4.FrameRate = targetRate;
open(vid4);
...
%                 end;
            ...
            if tempRate < targetRate;
                ...
                frame1 = frame;
                frame2 = frame;
                writeVideo(vid4, frame1);
                writeVideo(vid4, frame2);
            else;
                writeVideo(vid4, frame);
            end;

            if mod(iterVid4,10) == 0;
                %Save image count every 10 iterations
                if ismac == 1;
                    save('/Applications/SP2VideoManager/Temp/outputVid4.mat', 'finishVid4', 'iterVid4');
                elseif ispc == 1;
                    save([MDIR '\SP2VideoManager\Temp\outputVid4.mat'], 'finishVid4', 'iterVid4');
                end;
            end;
            iterVid4 = iterVid4 + 1;
        end;
