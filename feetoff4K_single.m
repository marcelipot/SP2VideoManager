function [] = feetoff4K_single(varargin);
...
val = get(handles2.feetoff4Kedit_main, 'String');

li = strfind(val, ',');
if isempty(li) == 0;
    set(handles2.feetoff4Kedit_main, 'String', num2str(handles2.feefoff4KVal));
    return;
end;
