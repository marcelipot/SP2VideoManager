function [] = fisheyeRadio3Select_screen(varargin);
...
if strcmpi(VidInfo.FishEye.fileFishEyeName(end-5:end-4), 'v3') == 1;
    set(handles2.fisheyeType1Radio_qual, 'Value', 0);
    set(handles2.fisheyeType2Radio_qual, 'Value', 0);
    set(handles2.fisheyeType3Radio_qual, 'Value', 1);
...
VidInfo.FishEye.fileFishEyeName = [VidInfo.FishEye.fileFishEyeName(1:end-6) 'v3.mat'];
VidInfo.FishEye.fileFishEyeLoaded = 'defined';
VidInfo.FishEye.fisheyeSourceType = 3;
