function [] = editaddPanning_conv(varargin);
...
if handles.checkboxPanning == 1;
    val = get(handles.editaddPanning_conv, 'String');
...
%     end;
    ...
    handles.addPanning = valnum;
    
    handles.trimPanning = 0;
    set(handles.edittrimPanning_conv, 'String', '0');
    
    guidata(handles.hf_w1_welcome, handles);
    
else;
    set(handles.editaddPanning_conv, 'String', '');
end;