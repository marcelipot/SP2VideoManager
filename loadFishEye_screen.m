function [] = loadFishEye_screen(varargin);
...
[file,path] = uigetfile({'*.*';'*.MAT';'*.mat'},...
                      'Select your set of fish eye parameters', handles2.defaultpath);
...
VidInfo.FishEye.fileFishEyeName = [];
VidInfo.FishEye.fileFishEyeLoaded = 'imported';
